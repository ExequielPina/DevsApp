    ...
    <head>
        ...
        <body>
                ...
                <div class="container mx-auto flex justify-between items-center">
                    ...
                    @auth
                        <nav class="flex gap-2 items-center">
                            ...
                            <a href="{{ route('posts.index', auth()->user()->username ) }}" class="font-bold text-gray-600 text-sm" href="">Bienveni@: <span class="font-normal">{{ auth()->user()->username}}</span></a>
            ...
            <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
                Devs - Todos los derechos reservados {{ now()->year }}
            </footer>
        </body>
</html>